...
#SBATCH --mem=2gb    # 2 GB of memory we want to reserve, if yours script exceed this memory, it will be killed by the system. 
#SBATCH --time=03:00:00     # also a hard limit, your script can run as long as an hour.
